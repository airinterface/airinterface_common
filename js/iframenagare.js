    ...
    iFrameNagare.prototype={
      ...
      initialize:function(){
        ...
        if((EDOMUtility.vOsType == EDOMUtility.osTypes.WINDOWS  ) && (EDOMUtility.ua.indexOf('Mobile') > -1)){
          ...
          that.element.style[EDOMUtility.vTransform] = "none";
          that.element.style[EDOMUtility.vP+"overflow-scrolling"] = "none";
        }
      ...
      log:function(msg) {
        ...
        }else if ( EDOMUtility.ua.toLowerCase().indexOf("iphone os 4") >=0 || EDOMUtility.ua.toLowerCase().indexOf("iphone os 5") >=0 ){
          /* HACK to lose CPU focus */
          $.get("/_clear.png?_="+ (new Date()).getTime());
        }
     ...
     _resetPos: function (time) {
      ...
      animate = function () {
        ...
        //this.log(" animating  duration = "+ duration + " step.time = " + step.time);
        if ( step.time <= ( duration ) || step.time == 0) {
